  ...
  describe ResultsJob, type: :job do
    ...
    context 'success' do
      ...
      it 'sends email' do
        ...
        expected_subject = I18n.t('location_mailer.location_results.subject')
        ...
        expected_url = Rails.application.routes.url_helpers.location_requests_result_path(req)
      ...
      context 'with errors' do
        ...
        it 'sends email' do
          ...
          expected_report = LocationMailer.record_errors_for(req)
