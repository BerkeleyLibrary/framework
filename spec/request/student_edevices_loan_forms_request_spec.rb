...
describe :student_edevices_loan_form, type: :request do
  it 'redirects to login' do
    expected_location = login_path(url: new_student_edevices_loan_form_path)
  ...
  describe 'with a valid user' do
    ...
    it 'rejects a submission with missing fields' do
      ...
      expect(response).to redirect_to(new_student_edevices_loan_form_path)
    end
    ...
    it 'accepts a submission' do
      ...
      expect(response).to redirect_to('/forms/student_edevices_loan/all_checked')
    end
    ...
    it 'redirects from :show to :new' do
      ...
      get student_edevices_loan_form_path(some_meaningless_id)
      expect(response).to redirect_to(new_student_edevices_loan_form_path)
    end
  end
end
